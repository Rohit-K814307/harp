...
def retrieve_data(total_samples=5, save_dir="data/raw/samples"):
     ...
     #harp_dir = os.getenv("HARPDIR")
     harp_dir = "/Users/rohitkulkarni/Documents/projects/conductr/harp"

     full_save_dir = os.path.join(harp_dir, "harp",save_dir)
     # print(full_save_dir)
     ...
     for sample in tqdm(sample_range, "Downloading Samples"):
          ...
          save_path = os.path.join(harp_dir, "harp", save_dir, f"sample_{sample}.zip")
          # print(save_path)
          urllib.request.urlretrieve(dnld_format, save_path)
          shutil.unpack_archive(save_path, os.path.join(harp_dir, "harp", save_dir))
          os.remove(save_path)
...
def combine_csv(sample_dir="data/raw/samples"):
     ...
     #harp_dir = os.getenv("HARPDIR")
     harp_dir = "/Users/rohitkulkarni/Documents/projects/conductr/harp"
     save_dir = os.path.join(harp_dir, "harp", "data", "raw", "cms_2008_2010_samples.csv")
